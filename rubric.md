...
**YES** 1 pt: The `House` class includes at least 2 overloaded methods (Constructor and isResident)

**YES** 1 pt: The `Library` class includes at least 2 overloaded methods (Constructor and isAvailable)

**YES** 1 pt: The `Cafe` class includes at least 2 overloaded methods (Constructors)
